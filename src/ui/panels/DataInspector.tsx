...
import type { Schema, Field, FmdRecord } from '../../fmd/types'

type Props = {
  schema: Schema
  store: Record<string, FmdRecord[]>
}
...
export default function DataInspector({ schema, store }: Props) {
          ...
          return (
            <div className="entity" key={key}>
              ...
              <div className="entity-fields">
                {(def.fields.length ? def.fields : ([{ name: '(inferred)' }] as Field[])).map((f) => (
